...
def parse_bosh_creds(json)
  s = JSON.parse(json, symbolize_names: true)[:credential]
...
env_lock = load_lock_file_from_url(lock_file_url)
...
bosh_creds = parse_bosh_creds(bosh_creds_json)
